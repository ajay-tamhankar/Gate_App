...
mixin _$DashboardMetrics {
  ...
  int get pendingReconciliations => throw _privateConstructorUsedError;
  int get matchedDraws => throw _privateConstructorUsedError;
  int get exceptionsRaised => throw _privateConstructorUsedError;
...
class _$DashboardMetricsCopyWithImpl<$Res, $Val extends DashboardMetrics>
  ...
  $Res call({
    ...
    Object? gateTat = null,
    Object? dockTat = null,
    Object? pendingReconciliations = null,
    Object? matchedDraws = null,
    Object? exceptionsRaised = null,
    ...
    return _then(_value.copyWith(
      ...
      dockTat: null == dockTat
          ...
          : dockTat // ignore: cast_nullable_to_non_nullable
              as double,
      pendingReconciliations: null == pendingReconciliations
          ? _value.pendingReconciliations
          : pendingReconciliations // ignore: cast_nullable_to_non_nullable
              as int,
      matchedDraws: null == matchedDraws
          ? _value.matchedDraws
          : matchedDraws // ignore: cast_nullable_to_non_nullable
              as int,
      exceptionsRaised: null == exceptionsRaised
          ? _value.exceptionsRaised
          : exceptionsRaised // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$DashboardMetricsImpl implements _DashboardMetrics {
  const _$DashboardMetricsImpl(
      ...
      required this.matchedDraws,
      required this.exceptionsRaised,
  ...
  @override
  final int matchedDraws;
  @override
  final int exceptionsRaised;
  ...
  @override
  String toString() {
    return 'DashboardMetrics(totalGateEntriesToday: $totalGateEntriesToday, totalGateEntriesMonth: $totalGateEntriesMonth, totalGrnPosted: $totalGrnPosted, pendingGrnCount: $pendingGrnCount, quantityMismatchCases: $quantityMismatchCases, duplicateGrnCases: $duplicateGrnCases, pendingGrnAging0To1: $pendingGrnAging0To1, pendingGrnAging2To3: $pendingGrnAging2To3, pendingGrnAgingMoreThan3: $pendingGrnAgingMoreThan3, gateTat: $gateTat, dockTat: $dockTat, pendingReconciliations: $pendingReconciliations, matchedDraws: $matchedDraws, exceptionsRaised: $exceptionsRaised, recentActivity: $recentActivity)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pendingReconciliations, pendingReconciliations) ||
                other.pendingReconciliations == pendingReconciliations) &&
            (identical(other.matchedDraws, matchedDraws) ||
                other.matchedDraws == matchedDraws) &&
            (identical(other.exceptionsRaised, exceptionsRaised) ||
                other.exceptionsRaised == exceptionsRaised) &&
...
abstract class _DashboardMetrics implements DashboardMetrics {
  const factory _DashboardMetrics(
          ...
          required final int pendingReconciliations,
          required final int matchedDraws,
          required final int exceptionsRaised,
          required final List<DailyActivity> recentActivity}) =
  ...
  double get dockTat;
  @override
  int get pendingReconciliations;
  @override
  int get matchedDraws;
  @override
  int get exceptionsRaised;
  @override
  List<DailyActivity> get recentActivity;
