...
abstract class $VendorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String vendor, String vendorCode, String vendorName});
}
...
class _$VendorImpl implements _Vendor {
  ...
  @override
  String toString() {
    return 'Vendor(vendor: $vendor, vendorCode: $vendorCode, vendorName: $vendorName)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, vendor, vendorCode, vendorName);
...
abstract class _Vendor implements Vendor {
  const factory _Vendor(
      ...
      required final String vendorName}) = _$VendorImpl;
